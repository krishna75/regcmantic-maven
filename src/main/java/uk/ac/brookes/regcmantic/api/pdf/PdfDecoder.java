...
//
//
//    public static final String version = "4.60b23-OS";
//     /**/
//
//
//
...
//                  */
//                    getTextLines().setLineAreas(null);
//
...
//                        getTextLines().addToLineAreas(pageTextAreas[k], pageTextDirections[k], pageNumber);
//                    }
//
//
...
//
//                                for(int k=0; k!=pageTextAreas.length; k++){
//                                    getTextLines().addToLineAreas(pageTextAreas[k], pageTextDirections[k], page);
//                                }
//                                if(debugRace)
...
//     */
//    final public EncryptionUsed getEncryptionType() {
//
//
//        if (currentPdfFile != null) {
//            PdfFileReader objectReader=currentPdfFile.getObjectReader();
...
//
//        }else
//            return EncryptionUsed.NOT_OPEN;
//    }
//
//
//    /**
...
//
//    	currentDisplay.drawImage(pageNumber, img, gs, false, "image", PDFImageProcessing.NOTHING, -1);
//
//    	//Set size for the given page as each page can be a different size
//    	if(isMultiPageTiff){
//    		if (img != null)
//				pageData.setMediaBox(new float[]{0,0,img.getWidth(),img.getHeight()});
//
...
//
//		//@Mark - We call setDisplayViewX from the eventDispatch thread only
//
...
//            currentOffset = new PageOffsets(pageCount, pageData);
//
//        //@Mark - We now call Display.init on the event thread
...
//            switch(type){
//                case -1 :
//                    this.setPDFCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
//                    break;
//                case DynamicVectorRenderer.TEXT :
//                    this.setPDFCursor(Cursor.getPredefinedCursor(Cursor.TEXT_CURSOR));
//                    break;
//                case DynamicVectorRenderer.IMAGE :
//                    this.setPDFCursor(Cursor.getPredefinedCursor(Cursor.CROSSHAIR_CURSOR));
//                    break;
